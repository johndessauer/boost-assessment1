...
export default function ThankYou({ contact }) {
  useEffect(() => {
    if (typeof fbq === 'function') {
      fbq('track', 'Purchase', { value: 67.00, currency: 'USD' })
    }
  }, [])
    ...
    <div style={styles.page}>
      ...
      <div style={styles.card}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <p style={{ fontSize: 16, color: colors.darkGray, marginTop: 8 }}>Your BOOST Blueprint Report is being generated right now.</p>
        </div>
        ...
        <a href="https://realwiseacademy.com/#programs" target="_blank" rel="noopener noreferrer" style={{ ...styles.btnPrimary, textDecoration: 'none', display: 'flex' }}>
